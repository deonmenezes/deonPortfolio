...
const Contact: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <p className="max-w-2xl mx-auto text-center text-lg mb-8 text-gray-400">
      ...
      <div className="flex justify-center gap-6 mb-12">
        {socialLinks.map((social) => (
          <motion.a
            ...
            title={social.name}
            className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-800 text-gold hover:bg-gold hover:text-black transition duration-300"
